...
public class MojingSDK
{
	...
	public static bool Unity_SetMojingWorld(string sGlassedName, bool bMultithread, bool bTimeWarp)
	{
		return true;
	}
	...
	[DllImport(dllName)]
	private static extern bool Unity_SetMojingWorld([MarshalAs(UnmanagedType.LPStr)]string sGlassesName, bool bMultithread, bool bTimeWarp);
    ...
    public static bool Unity_EnterMojingWorld(string sGlassesName, bool bMultithread, bool bTimeWarp)
    {
        ...
        if (Unity_SetMojingWorld(sGlassesName, bMultithread, bTimeWarp))
        {
